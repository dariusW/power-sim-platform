 ...
 *   <li>{@link pssimulation.impl.PSSimulationImpl#getConnections <em>Connections</em>}</li>
...
public class PSSimulationImpl extends MinimalEObjectImpl.Container implements PSSimulation {
     ...
     * @ordered
     */
    protected EList<PSHierarchy> connections;
     ...
     * @generated
     */
    public EList<PSHierarchy> getConnections() {
        if (connections == null) {
            connections = new EObjectContainmentEList<PSHierarchy>(PSHierarchy.class, this, PssimulationPackage.PS_SIMULATION__CONNECTIONS);
        }
        return connections;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case PssimulationPackage.PS_SIMULATION__CONNECTIONS:
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case PssimulationPackage.PS_SIMULATION__CONNECTIONS:
                ...
                getConnections().addAll((Collection<? extends PSHierarchy>)newValue);
                return;
            case PssimulationPackage.PS_SIMULATION__DESCRIPTION:
