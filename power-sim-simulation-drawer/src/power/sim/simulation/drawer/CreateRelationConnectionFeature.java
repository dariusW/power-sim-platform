...
public class CreateRelationConnectionFeature extends AbstractCreateConnectionFeature implements ICreateConnectionFeature {

    public CreateRelationConnectionFeature(IFeatureProvider fp) {
        super(fp, "Relation", "Creates a regerence beetwen parent and child installation");
    }
    ...
    public Connection create(ICreateConnectionContext context) {
        ...
        if ( source != null && target != null ) {
            ...
            addContext.setNewObject(PssimulationFactory.eINSTANCE.createPSComunication());
